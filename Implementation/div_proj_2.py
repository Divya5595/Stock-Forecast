...
def Set_Ticker():
    global stockTicker
    stockTicker = 'ONGC.NS'
    print("Enter the Following Text to select your StockTicker")
    print("Enter -->ONGC.NS ")
    print("Enter -->SBI.NS ")
    print("Enter -->LTITL.NS ")
    print("Enter -->TCS.NS")
    print("Enter -->INFOSYS.NS")
    #stockTicker = input("Enter the Ticker:")
    if(stockTicker == 'ONGC.NS'):
        print("You have chosen ONGC"),
    elif(stockTicker == 'SBI.NS'):
        print("You have chosen SBI"),
    elif (stockTicker =='LTITL.NS'):
        print("You have chosen LTITL"),
    elif (stockTicker =='TCS.NS'):
        print("You have chosen TCS"),
    elif (stockTicker =='INFOSYS.NS'):
        print("You have chosen INFOSYS")
    else:
        print ("Not Available")
    return 
...
#Output Table Header
print ('Company\t\tMonths\t   DataRows\t Accuracy%\t  Predicted Value')
...
for i in range(n): 
    ...
    print (stockTicker.partition('.')[0] +'\t'+ str(start_date) +'\t'+ str(len(X)) +'\t'+ str(accuracy*100) +'\t'+ str(forecast_set[0]))
